...
*******************************************************************************/
    ...
    public function __construct() // Lee modified
    {}

    function tFPDF($orientation='P', $unit='mm', $size='A4') // Lee modified
    {
	// Some checks
	$this->_dochecks();
...
function AddPage($orientation='', $size='', $rotation=0, $show_first_page=false, $h_page = 0)  // params added by Lee
{
	// Start a new page
	if($this->state==3)
	...
	// Page header
	$this->InHeader = true;
	$this->Header($show_first_page, $h_page); // params added by Lee
	$this->InHeader = false;
	// Restore line width
...
function Header($show_first_page=false, $h_page=0) // params added by Lee
{
...
function MultiCell($w, $h, $txt, $border=0, $align='J', $fill=false)
{
	...
	$this->x = $this->lMargin;
	return $nl; // added by Lee to report number of lines used
}
