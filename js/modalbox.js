...
(function ($) {
    ...
    let initModal=function(data){
        ...
        $(document).on("mousemove",function (e) {
            if (modal_box === "move") {
                // console.log((e.pageX - modal_box_new_left) + ' - ' + (e.pageY - modal_box_new_top));
                if (((e.pageX - modal_box_new_left) > 0 && e.pageX < window.innerWidth) && ((e.pageY - modal_box_new_top) > 0 && e.pageY < window.innerHeight)) { // added by Lee to prevent moving window off page 3/17/21
                    $moDialog.css(
                            {
                ...
                if ((e.pageY - modal_box_new_top) < window.innerHeight) { // added by Lee to prevent moving window off page 3/17/21
                ...
                // console.log((e.pageX - modal_box_new_left) + ' - ' + (e.pageY - modal_box_new_top));
                if ((e.pageX - modal_box_new_left) < window.innerWidth) { // added by Lee to prevent moving window off page 3/17/21
                ...
                if ((e.pageY - modal_box_new_top) > 0) { // added by Lee to prevent moving window off page 3/17/21
                ...
                if ((e.pageX - modal_box_new_left) > 0) { // added by Lee to prevent moving window off page 3/17/21
                ...
                if ((e.pageX - modal_box_new_left) > 0 && (e.pageY - modal_box_new_top) > 0) { // added by Lee to prevent moving window off page 3/17/21
                    dialog_resizing_height_tmp = (modal_box_bottom_fixed - (e.pageY - modal_box_top_dust));
                    dialog_resizing_height = (dialog_resizing_height_tmp > dialog_header_height) ? dialog_resizing_height_tmp : dialog_header_height;
                    dialog_resizing_width_tmp = (modal_box_right_fixed - (e.pageX - modal_box_left_dust));
                    dialog_resizing_width = (dialog_resizing_width_tmp > dialog_header_width) ? dialog_resizing_width_tmp : dialog_header_width;
            ...
            init : function(options)
            {
                ...
                return this.each(function(index)
                {
                    ...
                    if (!data)
                    {
                        ...
                        // lee added the svg icon below 3/17/21
                        $moDialog.prepend('<div class="titlebar noselect"><div class="titlebar_left"><div class="titlebar_title">' + settings.title + '</div></div><div class="titlebar_right"><div class="close"><i class="bi-x-circle ui-icon ui-icon-closethick" style="font-size: 24px;"></i></div></div><div class="box_clear"></div></div>');
