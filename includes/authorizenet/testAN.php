...
function getSettledBatchList()
{
    ...
    require_once('/srv/spectra/htadmin/anConstants');
    ...
    $firstSettlementDate=new DateTime("2011-01-01T00:00:00Z");
    ...
    $lastSettlementDate->setDate(2017,9,25);
    $lastSettlementDate->setTime(00,00,00);
